...
const Footer = () => {
  return (
    <div className="pt-20">
      ...
      <hr />
      <footer class="footer  items-center p-4 py-10 bg-neutral text-neutral-content">
        <div class="items-center mx-auto grid-flow-col">
          <svg
            width="36"
            height="36"
            viewBox="0 0 24 24"
        ...
        <div class="grid-flow-col mx-auto gap-4 md:place-self-center md:justify-self-end">
          <a>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
